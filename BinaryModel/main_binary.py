...
from models.binarized_modules_XNORSRAM import Conv2dV1, LinearV1
import numpy as np
...
parser.add_argument('-s', '--sram_depth', type=int, default=None,
                    metavar='N', help='SRAM Depth')
...
parser.add_argument('-SNR', type=float, default=100, help='SNR of noise injected')

parser.add_argument('--quant_bound',type=float, default=None, help='Quantization Range Bound')
parser.add_argument('--number_levels', type=float, default=None, help='Number of levels')
...
def main():
    ...
    if args.sram_depth:
        models.binarized_modules_XNORSRAM.SRAM_rows = args.sram_depth
    if args.offset_noise:
        models.binarized_modules_XNORSRAM.offsetnoise = args.offset_noise
    if args.bitline_noise:
        models.binarized_modules_XNORSRAM.bitlinenoise = args.bitline_noise
    if args.num_bits:
        models.binarized_modules_XNORSRAM.n_bits = args.num_bits
    if args.num_frac:
        models.binarized_modules_XNORSRAM.nf = args.num_frac
    if args.number_levels:
        models.binarized_modules_XNORSRAM.num_levels =  args.number_levels
    if args.quant_bound:
        models.binarized_modules_XNORSRAM.Bound = args.quant_bound
    ...
    model_config = {'input_size': args.input_size, 'dataset': args.dataset, 'depth': args.depth, 'act_precision': args.act_prec, 'SNR': args.SNR}
