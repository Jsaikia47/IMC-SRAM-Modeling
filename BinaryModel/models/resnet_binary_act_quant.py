...
from .binarized_modules_XNORSRAM import  LinearV1,Conv2dV1

__all__ = ['resnet_binary_act_quant']

def Binaryconv3x3(in_planes, out_planes, stride=1):
    "3x3 convolution with padding"
    return Conv2dV1(in_planes, out_planes, kernel_size=3, stride=stride,
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        self.conv1 = Conv2dV1(inplanes, planes, kernel_size=1, bias=False)
        self.bn1 = nn.BatchNorm2d(planes)
        self.conv2 = Conv2dV1(planes, planes, kernel_size=3, stride=stride,
                               padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(planes)
        self.conv3 = Conv2dV1(planes, planes * 4, kernel_size=1, bias=False)
    ...
    def _make_layer(self, block, planes, blocks, stride=1,do_bntan=True,act_precision=4):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                Conv2dV1(self.inplanes, planes * block.expansion,
...
class ResNet_imagenet(ResNet):
    ...
    def __init__(self, num_classes=1000,
        ...
        self.inplanes = 64
        self.conv1 = Conv2dV1(3, 64, kernel_size=3, stride=1, padding=1,bias=False)
        ...
        self.fc = LinearV1(512 * block.expansion, num_classes)
...
class ResNet_cifar10(ResNet):
    ...
    def __init__(self, num_classes=10,
        ...
        n = int((depth - 2) / 6)
        self.conv1 = Conv2dV1(3, 16*self.inflate, kernel_size=3, stride=1, padding=1,
                               bias=False)
        self.maxpool = lambda x: x
        ...
        self.bn3 = nn.BatchNorm1d(10)
        self.logsoftmax = nn.LogSoftmax()
        self.fc = LinearV1(64*self.inflate, num_classes)
